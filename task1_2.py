...
class RootFinder(ctk.CTk):
    def __init__(self):
        super().__init__()

        self.title("Поиск корней уравнений")
        ...
        self.func_entry.insert(0, "np.power(2, -x) - np.sin(x)")
        ...
        self.method_combo.set("Метод бисекции")
        self.method_combo.grid(row=4, column=0, padx=10, sticky="ew")
